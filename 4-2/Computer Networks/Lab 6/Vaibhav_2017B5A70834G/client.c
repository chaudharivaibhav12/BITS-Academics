...
int main(int argc, char *argv[])
{
    ...
    while(1)
    {
        ...
        //If exit is typed then the client must exit the program.
        ...
        //If server sends that the limit is reached then client must exit.
        if(strcmp(buffer,"Request Denied: 4 Client Limit Reached")==0)
        {
            printf("%s\n",buffer);
            return 0;
        }
